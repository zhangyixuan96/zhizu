        ...
        <!-- 第一部分 -->
         <div class="one_block">
             ...
             <table class="oneTable">
                    ...
                    <tr>
                        <td>支付方式</td>
                        <td>{{orderDetail.payType|payType}}</td>
                    </tr>
                    <tr>
                        <td>采购模式</td>
                        <td>{{orderDetail.purchaseType|purchaseType}}</td>
                    </tr>
                    <tr>
                        <!-- <td>入仓仓库</td> -->
                        <td>仓库名称</td>
                    ...
                    <tr>
                        <td>签订日期</td>
                        <td>{{orderDetail.signTimeString}}</td>
                    </tr>
                    <tr>
                        <td>预订到货日期</td>
                        <td>{{orderDetail.estimatedArrivalTimeString}}</td>
                    </tr>
                    <tr>
                        <td>智租资产号</td>
             ...
             <div class="scroll">
                <table class="srcollTable">
                        ...
                        <tr v-for="item in orderDetail.purchaseOrderProductList">
                            <!-- <td>{{item.id}}</td> -->
         ...
         <div class="one_block">
             ...
             <table class="oneTable">
                    ...
                    <tr>
                        <td>产品总折扣(%)</td>
                        <!-- <td>折扣</td> -->
                        <td>{{orderDetail.discountRate}}</td>
                    </tr>
                    <tr>
                        <td>产品其他费用(元)</td>
                        <!-- <td>其他费用</td> -->
                    ...
                    <tr>
                        <td>创建人</td>
                        <td>{{orderDetail.createUserName}}</td>
                    </tr>
                    <tr>
                        <td>创建时间</td>
                        <td>{{orderDetail.createTimeString}}</td>
                    </tr>
    ...
    export default {
        ...
        methods: {
            ...
            getOrderDetail(){
                ...
                vm.api(vm, "/api/app/order/getPurchaseOrderInfo.json", params, "post", function(res) {
                    console.log("res",res);
                    vm.orderDetail = res
                });
            },
