        ...
        <!-- 第一部分 -->
         <div class="one_block">
             ...
             <table class="oneTable">
                    ...
                    <tr>
                        <td>盘点时间</td>
                        <td>{{orderDetail.inventoryTime}}</td>
                    </tr>
                    <tr>
                        <td>备注</td>
    ...
    export default {
        ...
        methods: {
            ...
            getOrderDetail(){
                ...
                vm.api(vm, "/api/app/order/getInventoryInfo.json", params, "post", function(res) {
                    // console.log("res",res);
                    vm.orderDetail = res
                });
            },
