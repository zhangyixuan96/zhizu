        ...
        <!-- 第一部分 -->
         <div class="one_block">
             ...
             <table class="oneTable">
                    <tr>
                        <td>装配单号</td>
                        <td>{{orderDetail.assemblingNo}}</td>
                    </tr>
                    <tr>
                        <td>状态</td>
                    ...
                    <tr>
                        <td>装配日期</td>
                        <td>{{orderDetail.assemblingTime}}</td>
                    </tr>
                    <tr>
                        <td>备注</td>
                    ...
                    <tr>
                        <td>关联BOM清单</td>
                        <td>{{orderDetail.bomId}}</td>
                    </tr>
                    <tr>
                        <td>入库仓库</td>
                        <td>{{orderDetail.inRepositoryName}}</td>
                    </tr>
                    <tr>
                        <td>出库仓库</td>
                        <td>{{orderDetail.outRepositoryName}}</td>
                    </tr>
                    <tr>
                        <td>物料产品</td>
                    </tr>
             ...
             <div class="scroll">
                <table class="srcollTable">
                        ...
                        <tr v-for="item in orderDetail.outProductList">
            ...
            <!-- 滚动表格 -->
             <div class="scroll">
                <table class="srcollTable">
                        ...
                        <tr v-for="item in orderDetail.inProductList">
                            <td>{{item.productNo}}</td>
                            <td>{{item.productName}}</td>
                            <td>{{item.codeList|dealcodeList}}</td>
                            <td>{{item.num}}</td>
    ...
    export default {
        ...
        methods: {
            ...
            getOrderDetail(){
                ...
                vm.api(vm, "/api/app/order/getAssemblingInfo.json", params, "post", function(res) {
                    console.log("res",res);
                    vm.orderDetail = res
                });
            },
