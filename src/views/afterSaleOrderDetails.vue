        ...
        <!-- 第一部分 -->
         <div class="one_block">
             ...
             <table class="oneTable">
                    <tr>
                        <td>售后订单号</td>
                        <td>{{orderDetail.returnSn}}</td>
                    </tr>
                    <tr>
                        <td>售后原因</td>
                        <td>{{orderDetail.reasonType|reasonType}}</td>
                    </tr>
                    <tr>
                        <td>状态</td>
             ...
             <!-- <div class="scroll"> -->
                <!-- <table class="srcollTable">
                        ...
                        <tr v-for="item in orderDetail.orderProductList">
        ...
        <!-- 第二部分 -->
         <div class="one_block">
             ...
             <table class="oneTable">
                    <tr>
                        <td>售后订单类型</td>
                        <td>{{orderDetail.type | afterSaleType}}</td>
                    </tr>
                    <tr>
                        <td>订单备注</td>
             ...
             <!-- 补发滚动表格出库产品 -->
             <!-- <div class="scroll" v-if="orderDetail.type==1"> -->
             <div class="scroll">
                <table class="srcollTable">
                        <tr>
                            <th>产品名称</th>
                        ...
                        <tr v-for="item in orderDetail.inOrderProductList">
                            <td>{{item.productName}}</td>
                            <td>{{item.productNo}}</td>
             ...
             <table class="oneTable" v-if="orderDetail.type==2">
                    <tr>
                        <td>入库产品</td>
                    </tr>
             </table>
              <!-- 换货滚动表格入库产品 -->
             <div class="scroll" v-if="orderDetail.type==2">
                <table class="srcollTable">
                        <tr>
                            <th>产品名称</th>
                            <th>产品编号</th>
                        ...
                        <tr v-for="item in orderDetail.outOrderProductList">
                            <td>{{item.productName}}</td>
                            <td>{{item.productNo}}</td>
                            <td>{{item.codeList|dealcodeList}}</td>
                            <td>{{item.num}}</td>
             ...
             <table class="oneTable">
                    <tr>
                        <td>订单日期</td>
                        <td>{{orderDetail.orderTimeLong|date}}</td>
                    </tr>
                    <tr>
                        <td>回款总金额</td>
                        <td>{{orderDetail.backMoneyCount}}</td>
                    </tr>
                    <tr>
                        <td>回款计划</td>
             ...
             <!--表格 -->
                <table class="secondTable" v-for="item in orderDetail.planObjArr">
                        <tr>
                            <td>回款编号</td>
                            <td>{{item.backSn}}</td>
                        </tr>
                        ...
                        <tr>
                            <td>回款状态</td>
                            <td>{{item.status|returnStatus}}</td>
                        </tr>
                        <tr>
                            <td>回款类型</td>
                            <td>{{item.type |returnType}}</td>
                        </tr>
                        <!-- <td>预计回款时间</td> -->
                        <tr>
                            <td>回款时间</td>
                            <td v-if="item.isDue==2">{{item.backTime|date}}</td>
                            <td v-else>超过超过预计回款日：{{item.dueCount}}天</td>
                        </tr>
         ...
         <div class="one_block">
             ...
             <table class="oneTable">
                    ...
                    <tr>
                        <td>附件信息</td>
                        <td>{{orderDetail.fileObjArr|fileMessage}}</td>
                    </tr>
                    <!-- <tr>
                        <td>其他款项类型</td>
                        <td>{{orderDetail.address}}</td>
                    ...
                    <tr>
                        <td>汇款结束时间</td>
                        <td>{{orderDetail.endBackTime}}</td>
                    </tr>
                    <tr>
                        <td>问题设备追回提醒时间</td>
                        <td>{{orderDetail.timeType}}</td>
                    </tr> -->
                    <tr>
                        <td>负责商务</td>
                        <td>{{orderDetail.businessName}}</td>
                    </tr>
                    <tr>
                        <td>创建人</td>
                        <td>{{orderDetail.nickname}}</td>
                    ...
                    <tr>
                        <td>创建时间</td>
                        <td>{{orderDetail.createTimeLong |date}}</td>
                    </tr>
             </table>
                <div class="grey"></div>
    ...
    export default {
        ...
        methods: {
            ...
            getOrderDetail(){
                ...
                vm.api(vm, "/api/app/order/getReturnOrderInfo.json", params, "post", function(res) {
                    console.log("res",res);
                    vm.orderDetail = res
                });
            },
