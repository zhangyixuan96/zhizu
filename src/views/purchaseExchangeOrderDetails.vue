         ...
         <div class="one_block">
             ...
             <table class="oneTable">
                    ...
                    <tr>
                        <!-- <td>退货方式</td> -->
                        <td>方式</td>
                        <td>{{orderDetail.exchageType|exchageType}}</td>
                    </tr>
                    <tr>
                        <!-- <td>退货日期</td> -->
                        <td>日期</td>
                        <td>{{orderDetail.exchangeTimeString}}</td>
                    </tr>
                    <tr>
                        <td>物流公司名称</td>
                    ...
                    <tr>
                        <td>快递单号</td>
                        <td>{{orderDetail.expressNumber}}</td>
                    </tr>
                    <tr>
                        <td>姓名</td>
             ...
             <div class="scroll">
                <table class="srcollTable">
                        ...
                        <tr v-for="item in orderDetail.exchageProductDtoList">
         ...
         <div class="one_block">
             ...
             <table class="oneTable">
                    <tr>
                        <!-- <td>其他选项-合计金额 </td> -->
                        <td>合计金额 </td>
                        <td>{{orderDetail.returnPrice}}</td>
                    </tr>
                    <!-- <tr>
                        <td>物流公司链接</td>
                        <td>{{orderDetail.url}}</td>
                    </tr> -->
    ...
    export default {
        ...
        methods: {
            ...
            getOrderDetail(){
                ...
                vm.api(vm, "/api/app/order/getPurchaseExchangeInfo.json", params, "post", function(res) {
                    console.log("res",res);
                    vm.orderDetail = res
                });
            },
